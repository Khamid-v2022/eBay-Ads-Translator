...
@section('content')
    <h1 class="text-3xl font-semibold mb-6">Editar Envío</h1>
    ...
    <div class="bg-white p-4 rounded shadow mb-4">
        ...
        @endif
        <form action="{{ route('shipping.update', $shipping->id) }}" method="post" class="my-4" id="store-manage-form">
            @csrf
                ...
                <div class="row">
                        ...
                        <div class="mb-4 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="input-group mb-3">
                                <select class="form-select single-select" required name="site_id">
                                    <option value="{{$marketplaces->site_id }}" selected>{{$marketplaces->site_name }}</option>
                        ...
                        <div class="mb-4 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="input-group mb-3">
                                <select class="form-select" required name="shipping_service" id="shipping-methods">
                                    <option value="{{$shipping->shipping_service }}" selected >{{$shipping->shipping_service }}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center">
                        <div class="mb-4 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="number" name="shipping_service_cost" value="{{$shipping->shipping_service_cost }}" class="border border-gray-500 rounded py-2 px-3 w-full" required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center">
                        <div class="mb-4 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" name="location" value="{{$shipping->location }}" class="border border-gray-500 rounded py-2 px-3 w-full" required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center">
                        <div class="mb-4 col-lg-6 col-md-6 col-sm-12">
                            ...
                            {{-- <input type="number" name="free_shipping" class="border border-gray-500 rounded py-2 px-3 w-full" required> --}}
                            <select class="form-select" name="free_shipping" id="" >
                                <option selected disabled value="{{$shipping->free_shipping }}">{{ !empty($shipping->free_shipping) ? "Yes" : "No" }}</option>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center">
                        <div class="mb-4 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" name="shipping_type" value="{{$shipping->shipping_type }}" class="border border-gray-500 rounded py-2 px-3 w-full" required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center">
                        <div class="mb-4 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" name="dispatch_time_max" value="{{$shipping->dispatch_time_max }}" class="border border-gray-500 rounded py-2 px-3 w-full" required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center">
                        <div class="mb-4 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" name="returns_accepted" value="{{$shipping->returns_accepted }}" class="border border-gray-500 rounded py-2 px-3 w-full" required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center">
                        <div class="mb-4 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" name="returns_accepted_option" value="{{$shipping->returns_accepted_option }}" class="border border-gray-500 rounded py-2 px-3 w-full" required>
                        </div>
                    </div>
